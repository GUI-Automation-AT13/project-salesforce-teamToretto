 ...
 */
public class IndividualPageCreated extends BasePage implements FeatureCreated {
     ...
     */
    public IndividualPageCreated(WebDriverManager webDriverManager) {
     ...
     */
    public IndividualsPage deleteCreatedIndividual() {
